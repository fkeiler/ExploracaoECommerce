const salesOverTimeObserver = new IntersectionObserver((entries, observer) =>
  d3.csv('./data/raw_data/olist_orders_dataset.csv').then(function (dataset_orders) {
...
salesOverTimeObserver.observe(document.querySelector('#sales-over-time'))
